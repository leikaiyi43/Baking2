...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    graphVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:NSLocalizedString(@"Tools", @"图表") image:[UIImage imageNamed: @"tab1U.png"] selectedImage:[UIImage imageNamed: @"tab1S.png"]];
