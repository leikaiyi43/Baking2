...
//        CGSizeMake(xOffset + copysign(0.1, xOffset), yOffset + copysign(0.1, yOffset)), 5, [[UIColor whiteColor] colorWithAlphaComponent:1].CGColor);
...
//        return [UIColor colorWithRed:0.9 green:0.06 blue:1.0 alpha:1.0];
//    }
//    return _color;
//}
...
- (UIColor *)background {
   ...
   //     return [UIColor colorWithRed:0.51f green:0.51f blue:0.51f alpha:1.00f];
        return [UIColor colorWithRed:0.92f green:0.92f blue:0.92f alpha:1.0f];
    }
    return _background;
}
